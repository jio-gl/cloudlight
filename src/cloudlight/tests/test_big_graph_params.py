...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.graph.load_compressed_graph(cloudlight.tests.data_enc1, use_big_alphabet, False)
    ...
    def testClusteringInverse(self):
        ...
        self.graph.create_index_clustering()
        deg_one_nodes = list(self.graph.get_parameter_cache_inverse('clustering', 0.666666))
    ...
    def testGetClustering(self):
        ...
        self.assertAlmostEqual( self.graph.get_parameter_cache('clustering', node), 0.66666666666 )
